// Source: https://raw.githubusercontent.com/nicdraffin/Village-Rentals-App/master/Data/DatabaseContext.cs

using System.Linq.Expressions;
using SQLite;
using SAD_Final_Prototype.Models;

namespace SAD_Final_Prototype.Code
{
    public class DatabaseContext : IAsyncDisposable
    {
        private const string DbName = "Village.db3";
